...
package com.panhealth.bluetoothchat;
...
public class BluetoothChatService {
 ...
 private static final UUID MY_UUID = UUID.fromString("00001101-0000-1000-8000-00805f9b34fb");//Soham
    // Member fields
    ...
    private void connectionFailed() {
        ...
        Log.d(TAG, "error in connection failed is------" + msg);
        Bundle bundle = new Bundle();
    ...
    private class ConnectThread extends Thread {
        ...
        public ConnectThread(BluetoothDevice device) {
            ...
            try {
                ...
                Log.d(TAG, "line 317 ran");
            } catch (IOException e) {
                Log.e(TAG, "create() failed", e);
                Log.d(TAG, "line 320 ran");
            }
            mmSocket = tmp;
                Log.d(TAG, "line mmsocket ran");
